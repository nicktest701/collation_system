...
import {
  putParliamentarian,
  putParliamentarianProfile,
} from '../../api/parliamentarianAPI';
...
const EditParliamentarian = () => {
  ...
  useEffect(() => {
    ...
    setDateofbirth(moment(new Date(data.dateofbirth)));
  ...
  const { mutateAsync: profileMutate } = useMutation({
    mutationFn: putParliamentarianProfile,
  });
  ...
  const handleImageUpload = (e) => {
    ...
    if (image) {
      ...
      profileMutate(profileInfo, {
        onSettled: () => {
          queryClient.invalidateQueries(['parliamentarian']);
...
export default EditParliamentarian;
